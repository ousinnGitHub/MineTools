...
# /html/body/div[2]/div/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/div/div/div[5]/button
# SUBMIT_BUTTON_XPATH = "/html/body/div[2]/div/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/div/div/div[6]/button"
SUBMIT_BUTTON_XPATH = "/html/body/div[2]/div/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/div/div/div[5]/button"
LOGGER = logging.getLogger()


def run(driver, shoe_type, username, password, url, shoe_size, shipping_option, login_time=None, release_time=None,
        shipping_address=None, page_load_timeout=None, screenshot_path=None, html_path=None, select_payment=False,
        purchase=False,
        ...
        try:
            ...
            if skip_payment is False:
                ...
                try:
                    ...
                    # /html/body/div[2]/div/div/div[2]/div/div/div/div/div[2]/div/div/div[2]/div/span/span[1]/div/button
    ...
    if skip_size_selection:
        ...
        if re.search("[a-zA-Z]", size_text):
            ...
            if shoe_type in ("Y", "C"):
                ...
                if shoe_size == "9":
                    JP_shoe_size = "27"
                shoe_size_type = "JP" + " " + JP_shoe_size
...
if __name__ == "__main__":
    ...
    run(driver=driver, shoe_type=shoe_type, username=args.username, password=args.password, url=args.url,
        shoe_size=args.shoe_size, shipping_option=args.shipping_option,
        login_time=args.login_time, release_time=args.release_time, shipping_address=shipping_address,
